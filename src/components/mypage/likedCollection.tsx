...
const PlatformSet = ({ data }: { data: LikedCollectionData }) => {
...
const CollectionAmount = ({ data }: { data: LikedCollectionData }) => {
  return (
    <CollectionDetail>
...
const HeaderLine = ({ data }: { data: LikedCollectionData }) => {
  const areArraysEqual = (arr1: string[], arr2: string[]) => {
    return (
      arr1.length === arr2.length &&
      new Set(arr1).size === new Set([...arr1, ...arr2]).size
...
const HoverCollection = ({ data }: { data: LikedCollectionData }) => {
  return (
    <HoverWrapper>
...
const BoardingPassBottom = ({ data }: { data: LikedCollectionData }) => {
