...
//   // // 만약 localStorage에 저장된 진도율 >= 80이면, 수강 완료 상태로 설정
//   // useEffect(() => {
//   //   const storedProgress =
//   //     Number(localStorage.getItem(`progress-${episodeId}`)) || 0;
//   //   if (storedProgress >= 80) setLocalIsCompleted(true);
//   // }, [episodeId]);
...
//     updateProgress(episodeId, storedProgress);

//     if (storedProgress >= 80) {
//       setLocalIsCompleted(true);
...
//       setLocalIsCompleted(false);
//     }
//   }, [episodeId, setIsCompleted, updateProgress, context.state.isCompleted]);
